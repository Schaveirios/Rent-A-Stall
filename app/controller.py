...
def index2():
    ...
    return render_template("admin_dashboard.html", x=x, y=y, result=result, result2=result2)
...
def AddTenants():
    ...
    if request.method == "POST":
        if form.validate_on_submit():
            ...
            flash("Stall not found")
    return render_template("addtenant.html", form1=form, availstalls = availstalls, page='addtenant', x=x, y=y, result=result, result2=result2)
